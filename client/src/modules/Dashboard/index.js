...
const Dashboard = () => {
    ...
    const handleImageSelect = (e) => {
        ...
        if (file) {
            // You can perform any necessary operations with the selected image here.
            // For example, you can set it in state or send it to a server.
	...
	const handleSignOut = () => {
		// Perform the sign-out logic here, including clearing localStorage.
		...
		<div className='w-screen flex'>
			<div className='w-[25%] h-screen bg-secondary overflow-scroll'>
				<div className='flex items-center my-8 mx-14'>
					...
					<button
						className='ml-4 rounded-full bg-red-500 text-white hover:bg-red-600 transition duration-300 ease-in-out p-1.5 text-xs'
			...
			<div className='w-[50%] h-screen bg-white flex flex-col items-center'>
				...
				</div>
				{
					...
					<div className='p-14 w-full flex items-center'>
						...
						<div className={`ml-4 p-2 cursor-pointer bg-light rounded-full hover:bg-blue-100 ${!message && 'pointer-events-none'}`} onClick={() => sendMessage()}>
						...
						<label htmlFor="imageInput" className={`ml-4 p-2 cursor-pointer bg-light rounded-full text-blue-600 hover:bg-blue-100`}>
                        <input
                            type="file"
                            id="imageInput"
                            style={{ display: 'none' }}
